...
/*  
    Introducing a structure variable that completely describes a cell in the domain.
    Each element in the bool array gives information on what surrounds the cell and the type of cell
*/
struct cellNeighbourBool
    {
      bool B_N;
      bool B_S;
      bool B_W;
...
class Cell {
  public:
    ...
    void SetCellNeighbourBool(bool,bool,bool,bool);
    cellNeighbourBool getCNB();
  ...
  private:
    ...
    int _j{0};
    /// Cell type
    cell_type _type{cell_type::FLUID};
    ...
    /// SOUTEAST -- WHY NOT SOUTHWEST AND NORTHEAST?
    // _neighbours is an array containing the pointers to neighbouring cells.
    std::array<Cell *, 6> _neighbours;

   // Declaring a private variable of type cellInformation
    cellNeighbourBool _cell_neighbour_bool;
