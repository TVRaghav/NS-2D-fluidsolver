...
class Discretization {
  public:
     ...
     *
     */
    static double diffusion(const Matrix<double> &A, int i, int j,int imax, int jmax);
     ...
     *
     */
    static double convection_u(const Matrix<double> &U, const Matrix<double> &V, int i, int j, int imax, int jmax);
     ...
     *
     */
    static double convection_v(const Matrix<double> &U, const Matrix<double> &V, int i, int j, int imax, int jmax);
     ...
     *
     */
    static double laplacian(const Matrix<double> &P, int i, int j,int imax, int jmax);
    ...
    double convection_t(const Matrix <double> &T, const Matrix<double> &U, const Matrix<double> &V, int i, int j,int imax, int jmax);
